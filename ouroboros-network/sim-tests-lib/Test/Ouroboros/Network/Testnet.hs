  ...
  let sim :: forall s . IOSim s Void
      sim = do
        ...
        diffusionSimulation (toBearerInfo bi)
                            ...
                            iosimTracer
   in labelDiffusionScript ds
    $ exploreSimTrace (\a -> a {explorationReplay = Just (ControlAwait [ScheduleMod (RacyThreadId [2,1,3,1,2,3,1],1) ControlDefault [(RacyThreadId [2,1,3,1,2,3],15),(RacyThreadId [2,1,3,1,2,3],16),(RacyThreadId [2,1,3,1,2,3],17),(RacyThreadId [2,1,3,1,2,3],18),(RacyThreadId [2,1,3,1,2],17),(RacyThreadId [2,1,3,1,2],18),(RacyThreadId [2,1,3,1,2],19),(RacyThreadId [2,1,3,1,2],20),(RacyThreadId [2,1,3,1,2,4],0),(RacyThreadId [2,1,3,1,2,4],1),(RacyThreadId [2,1,3,1,2],21),(RacyThreadId [2,1,3,1,2],22),(RacyThreadId [2,1,3,1,2],23),(RacyThreadId [2,1,3,1],21),(RacyThreadId [2,1,3,1],22),(RacyThreadId [2,1,3,1],23),(RacyThreadId [2,1,3,1],24),(RacyThreadId [2,1,3,1],25),(RacyThreadId [2,1,3,1,3],0),(RacyThreadId [2,1,3,1,3],1),(RacyThreadId [2,1,3,1],26),(RacyThreadId [2,1,3,1],27),(RacyThreadId [2,1,3,1],28),(RacyThreadId [2,1,3,1],29),(RacyThreadId [2,1,3,1,4],0),(RacyThreadId [2,1,3,1,4],1),(RacyThreadId [2,1,3,1,4],2),(RacyThreadId [2,1,3,1],30),(RacyThreadId [2,1,3,1],31),(RacyThreadId [2,1,3,1],32),(RacyThreadId [2,1,3],3),(RacyThreadId [2,1,3],4),(RacyThreadId [2,1,3],5),(RacyThreadId [2,1,3],6),(RacyThreadId [2,1,3,2],0),(RacyThreadId [2,1,3,2],1),(RacyThreadId [2,1,3],7),(RacyThreadId [2,1,3],8),(RacyThreadId [2,1,3],9),(RacyThreadId [2,1],33),(RacyThreadId [2,1],34),(RacyThreadId [2,1],35),(RacyThreadId [2,1],36),(RacyThreadId [2,1,4],0),(RacyThreadId [2,1,4],1),(RacyThreadId [2,1,4],2),(RacyThreadId [2,1,4],3),(RacyThreadId [2,1],37),(RacyThreadId [2,1],38),(RacyThreadId [2,1],39),(RacyThreadId [2],5),(RacyThreadId [2],6),(RacyThreadId [2],7),(RacyThreadId [2,1,3,1,2,3],19)]]) })
                      sim $ \_ ioSimTrace ->
...
unit_1 :: Property
unit_1 =
  testWithIOSimPOR prop_diffusion_nofail 8911 bi ds
  where
    bi =
      AbsBearerInfo
