...
import Ouroboros.Cardano.Network.PublicRootPeers qualified as CNPRP
...
prop_arbitrary_CardanoPublicRootPeers = property . PublicRootPeers.invariant CNPRP.invariant CNPRP.toSet
...
prop_shrink_CardanoPublicRootPeers x =
      prop_shrink_valid (PublicRootPeers.invariant CNPRP.invariant CNPRP.toSet) x
...
prop_fromMapAndSet pp bsp lp =
  let newPP = pp `Map.withoutKeys` bsp
   in PublicRootPeers.invariant CNPRP.invariant CNPRP.toSet
...
prop_merge :: PublicRootPeers (CardanoPublicRootPeers PeerAddr) PeerAddr
           ...
           -> Bool
prop_merge prp = PublicRootPeers.invariant CNPRP.invariant CNPRP.toSet
               . (<> prp)
...
prop_insertPublicConfigPeer prp p pa =
  PublicRootPeers.invariant CNPRP.invariant CNPRP.toSet (PublicRootPeers.insertPublicConfigPeer p pa prp)

prop_insertBootstrapPeer :: PublicRootPeers (CardanoPublicRootPeers PeerAddr) PeerAddr
                         -> PeerAddr
                         -> Bool
prop_insertBootstrapPeer prp p =
  PublicRootPeers.invariant CNPRP.invariant CNPRP.toSet (PublicRootPeers.insertBootstrapPeer p prp)

prop_insertLedgerPeer :: PublicRootPeers (CardanoPublicRootPeers PeerAddr) PeerAddr
                      -> PeerAddr
                      -> Bool
prop_insertLedgerPeer prp p =
  PublicRootPeers.invariant CNPRP.invariant CNPRP.toSet (PublicRootPeers.insertLedgerPeer p prp)

prop_insertBigLedgerPeer :: PublicRootPeers (CardanoPublicRootPeers PeerAddr) PeerAddr
                         -> PeerAddr
                         -> Bool
prop_insertBigLedgerPeer prp p =
  PublicRootPeers.invariant CNPRP.invariant CNPRP.toSet (PublicRootPeers.insertBigLedgerPeer p prp)
