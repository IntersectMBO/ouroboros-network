...
belowTargetLocal actions@PeerSelectionActions {
  ...
  = Guarded Nothing $ do
      ...
      return $ \_now -> Decision {
        ...
        decisionJobs  = [ jobPromoteColdPeer actions policy peer
                                             extraFlags
                                             IsNotBigLedgerPeer
                                             diffusionMode
