...
prop_directBlockFetchClientProtocol_ST as = runST $ runExperiment $
  blockFetchClientProtocol_experiment @(Free (SimF _)) (\ser cli -> void $ directBlockFetchClient ser cli) as
...
prop_connectBlockFetchClientProtocol_ST as = runST $ runExperiment $
  blockFetchClientProtocol_experiment @(Free (SimF _)) (\ser cli -> void $ connect (blockFetchServerReceiverStream ser) (blockFetchClientSenderStream cli)) as
