...
demo chain0 updates = do
    ...
    let Just expectedChain = Chain.applyChainUpdates updates chain0
        ...
        consumerPeers = MuxClientApplication $ \Mxt.ChainSync1 channel -> runPeer nullTracer (ChainSync.codecChainSync encode encode decode decode) channel consumerPeer
        ...
        producerPeers = MuxServerApplication $ \Mxt.ChainSync1 channel -> runPeer nullTracer (ChainSync.codecChainSync encode encode decode decode) channel producerPeer
