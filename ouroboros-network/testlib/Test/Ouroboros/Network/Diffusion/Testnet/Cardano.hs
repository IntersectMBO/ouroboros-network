...
prop_a = prop_churn_notimeouts_iosim
          ...
          (DiffusionScript
            ...
            [(NodeArgs (43) InitiatorOnlyDiffusionMode (Just 0.932114521803)
               ...
               (Nothing)
               False
               (Script (FetchModeDeadline :| [FetchModeBulkSync,FetchModeDeadline,FetchModeBulkSync,FetchModeDeadline,FetchModeBulkSync,FetchModeDeadline,FetchModeDeadline]))
               ,[JoinNetwork 31]
