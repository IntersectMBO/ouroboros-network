...
data DiffusionTracers = DiffusionTracers {
    ...
    , dtConnectionManagerLocalTracer
        :: Tracer IO (ConnectionManagerTrace
                       LocalAddress
...
runDataDiffusion tracers
                 ...
                 DiffusionApplications { daApplication, daLocalResponderApplication } =
    withIOManager $ \iocp ->
      ...
      let localConnectionHandler
          ...
          localConnectionHandler =
            makeConnectionHandler
              ...
              HandshakeArguments {
                  haHandshakeTracer = dtHandshakeLocalTracer,
          ...
          localConnectionManagerArguments =
            ConnectionManagerArguments {
                connectionManagerTracer      = dtConnectionManagerLocalTracer,
                connectionManagerMuxTracer   = dtMuxLocalTracer,
        ...
        Async.withAsync
          (Server.run
            ServerArguments {
                ...
                serverTracer            = dtServerLocalTracer,
...
withLocalSocket :: IOManager
                ...
                -> ((LocalSnocket, Socket.Socket) -> IO a)
                -> IO a
