...
import Ouroboros.Network.PeerSelection.LedgerPeers.Util
  (accBigPoolStake, reRelativeStake, bigLedgerPeerQuota)
          ...
          if age > peerListLifeTime
             then case useLedgerPeers of
               ...
               UseLedgerPeers ula -> do
                 ...
                 traceWith tracer $ FetchingNewLedgerState (Map.size peersStake) (Map.size bigPeersStakeMap)
