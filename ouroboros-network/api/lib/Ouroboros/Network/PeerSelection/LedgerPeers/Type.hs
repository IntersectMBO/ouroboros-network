...
instance Typeable a => StandardHash (LedgerPeerSnapshot a)
type instance HeaderHash (LedgerPeerSnapshot a) = Hash Blake2b_256 (LedgerPeerSnapshot a)
...
encodeLedgerPeerSnapshotPoint :: Typeable a => Point (LedgerPeerSnapshot a) -> Codec.Encoding
encodeLedgerPeerSnapshotPoint = \case
  ...
  BlockPoint { atSlot, withHash } ->
    ...
    <> Codec.toCBOR atSlot <> Codec.toCBOR withHash


decodeLedgerPeerSnapshotPoint :: Typeable a => Codec.Decoder s (Point (LedgerPeerSnapshot a))
