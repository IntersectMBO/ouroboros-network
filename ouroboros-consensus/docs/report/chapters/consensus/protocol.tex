...
a specialised ledger for non-fungible tokens, a scripting a language, or
...
decisions on either side were finalised. Partly however it is also due to
...
layer to verify transactions, and would (ideally) also depend on the ledger layer
