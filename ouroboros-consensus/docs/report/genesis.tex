...
\frametitle{Generalizing genesis mode}
...
\begin{itemize}
\item Cannot reliable detect whether we have more than $k$ blocks \\
(node reports tip but we cannot verify)
\item \emph{Can still apply genesis condition}, independent of number of blocks. \\
