...
- [ ] #277 Correctly deal with partial reads and writes [PR https://github.com/input-output-hk/ouroboros-network/pull/551]
...
- [ ] #292 Support O_EXCL in posix bindings [PR https://github.com/input-output-hk/ouroboros-network/pull/552]
- [ ] #398 Delete remaining unit test
- [ ] #502 Mock FS system: deal with non-deterministic hGetSome and hPutSome
- [ ] #532 Make `ioToFsError` OS specific [PR forthcoming]
...
- [ ] #501 Incremental DB does not support incremental decoders
...
- [ ] #191 Integrate pre-Shelley era ledger [WIP PR at https://github.com/input-output-hk/ouroboros-network/pull/531]
...
- [ ] #244 Header validation without corresponding bodies [can be closed after https://github.com/input-output-hk/ouroboros-network/pull/531, provided we test the demo]
...
- [ ] #265 Implement mempool [can be closed after https://github.com/input-output-hk/ouroboros-network/pull/531, provided we test the demo]
