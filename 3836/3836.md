...
I've also modified the immediate context of this error to save up to a single
traversal of the action/domain lists:
```hs
...
-- New: zip and traverse `as` and `domains` together
let domain :: DomainAccessPoint
