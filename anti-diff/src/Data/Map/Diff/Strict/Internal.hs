...
-- | Based on @Data.Map.Diff.Strict.Ver2b@.
...
--
-- Note: The @Anti-@ constructors are only used to cancel out entries in a
-- diff history. These constructors should not be exposed from the module.
...
--
-- Note: This implementation does not make any assumptions about the inputs it is
...
-- | Given a valid @DiffHistory@, its @DiffEntry@s should fold to a sensible @Act@.
--
