...
instance  ( Typeable c
          , Typeable ext
          , ConvertRawHash (SimpleBlock c ext)
          , SerialiseNodeToClient (SimpleBlock c ext) (SimpleBlock c ext)
          , SerialiseNodeToClient (SimpleBlock c ext) (Serialised (SimpleBlock c ext))
          , SerialiseNodeToClient (SimpleBlock c ext) (GenTx (SimpleBlock c ext))
          , SerialiseNodeToClient (SimpleBlock c ext) (ApplyTxErr (SimpleBlock c ext))
          , SerialiseNodeToClient (SimpleBlock c ext) (SomeSecond BlockQuery (SimpleBlock c ext))
          , SerialiseNodeToClient (SimpleBlock c ext) (LedgerConfig (SimpleBlock c ext))
          , SerialiseResult       (SimpleBlock c ext) (BlockQuery (SimpleBlock c ext))
          ) => SerialiseNodeToClientConstraints (SimpleBlock c ext)
