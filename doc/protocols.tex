...
\subsubsection{Phase 1, establishing common intersection}
...
\end{tikzpicture}
\end{center}
After applying a fork, the producer will send to the consumer either $\var{MsgRollForward}\;\var{block}$ or $\var{MsgRollBackward}\;\var{point'}$.
