                  ...
                  case mConn of
                    ...
                    Just conn@Connection { connState = SYN_SENT } -> do
                      ...
                      when (localAddress connId /= remoteAddress) $
                        -- We are connecting to onself.  On Linux, such
                        -- connections are never accepted, instead the `connect`
                        -- returns a socket which is self connected, see
                        -- `mkConnection`.
                        writeTBQueue queue
                                     ChannelWithInfo
