...
--
newtype DataFlowProtocolData = DataFlowProtocolData { getProtocolDataFlow :: DataFlow }
  deriving (Eq, Show)
...
dataFlowProtocol :: DataFlow
                 ...
                 -> Versions UnversionedProtocol
                             DataFlowProtocolData
                             app
dataFlowProtocol dataFlow = simpleSingletonVersions UnversionedProtocol (DataFlowProtocolData dataFlow)
