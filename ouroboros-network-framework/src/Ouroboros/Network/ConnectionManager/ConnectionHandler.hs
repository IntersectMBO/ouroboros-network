  ...
  where
    ...
    outboundConnectionHandler
        ...
        muxBearer =
          Action {
              ...
              errorHandler = exceptionHandling muxPromiseVar remoteAddress OutboundError
            }
      where
        outboundAction = do
    ...
    inboundConnectionHandler muxPromiseVar tracer connectionId@ConnectionId { remoteAddress } muxBearer =
          Action {
              ...
              errorHandler = exceptionHandling muxPromiseVar remoteAddress InboundError
            }
      where
        inboundAction = do
    ...
    exceptionHandling :: forall x.
                      ...
                      -> ErrorContext
                      -> m x -> m x
    exceptionHandling muxPromiseVar remoteAddress errorContext io =
