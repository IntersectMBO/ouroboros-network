    ...
    server ns = do
        ...
        bracket (open snocket TestFamily)
                ...
                (\fd -> do
                  ...
                  listen snocket fd
                  acceptLoop threadsVar (accept snocket fd))
          `finally` do
                ...
                $ \fd -> do
                  ...
                  withAsync
                    ...
                    $ \_ -> do
                      res <- atomically resSTM
                      stopMux mux
                      say $ "CLIENT TERMINATED: " ++ show res
                      case res of
...
toSduSize SmallSDU  = 1_024
toSduSize NormalSDU = 12_228
toSduSize LargeSDU  = 32_768
