...
, stm, serialise , string-conv, tasty, tasty-quickcheck, text, transformers
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    cryptonite fingertree free hashable memory mtl network pipes psqueues
    process psqueues QuickCheck random semigroups serialise stm string-conv
