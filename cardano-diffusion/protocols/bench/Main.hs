...
import Cardano.Network.Protocol.BlockFetch.Type
import Cardano.Network.Protocol.ChainSync.Codec.CDDL
import Cardano.Network.Protocol.ChainSync.Type
import Cardano.Network.Protocol.ChainSync.Type qualified as ChainSync
import Cardano.Network.Protocol.Handshake.Codec
import Cardano.Network.Protocol.Handshake.Type
import Cardano.Network.Protocol.KeepAlive.Codec
import Cardano.Network.Protocol.KeepAlive.Type
...
import Cardano.Network.Protocol.LocalStateQuery.Test hiding (Query)
import Cardano.Network.Protocol.LocalStateQuery.Type
...
import Cardano.Network.Protocol.LocalTxMonitor.Type
...
import Cardano.Network.Protocol.LocalTxSubmission.Type
import Cardano.Network.Protocol.LocalTxSubmission.Type qualified as LocalTxSubmission
import Cardano.Network.Protocol.PeerSharing.Codec
import Cardano.Network.Protocol.PeerSharing.Type
...
import Cardano.Network.Protocol.TxSubmission2.Test
import Cardano.Network.Protocol.TxSubmission2.Type
        ...
        let printMsg :: AnyMessage (PeerSharing SockAddr) -> String
         ...
         in concat
              [ benchmarkCodec ("PeerSharing " ++ printMsg msg ++ " " ++ show ntnVersion)
                               codecPeerSharing ntnVersion msg
