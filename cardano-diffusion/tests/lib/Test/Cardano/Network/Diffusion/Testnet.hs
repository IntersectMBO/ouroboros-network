      ...
      DiffusionScript (SimArgs 1 10 defaultTxDecisionPolicy)
        ...
        [ ( NodeArgs (-6) InitiatorAndResponderDiffusionMode
          ...
          , [JoinNetwork 1.742_857_142_857
            ...
            ,Reconfigure 23.888_888_888_88 [(1,1,Map.empty),(1,1,Map.fromList [(RelayAccessAddress "0:6:0:3:0:6:0:5" 65_530,LocalRootConfig DoAdvertisePeer InitiatorAndResponderDiffusionMode Outbound IsNotTrustable)])]
            ,Reconfigure 4.870_967_741_935 [(1,1,Map.fromList [(RelayAccessDomain "test2" 65_535,LocalRootConfig DoAdvertisePeer InitiatorAndResponderDiffusionMode Outbound IsNotTrustable)])]
            ]
          )
