...
import Cardano.Network.Protocol.LocalStateQuery.Client as LocalStateQuery
import Cardano.Network.Protocol.LocalStateQuery.Type qualified as LocalStateQuery
import Cardano.Network.Protocol.LocalTxMonitor.Client as LocalTxMonitor
import Cardano.Network.Protocol.LocalTxMonitor.Type qualified as LocalTxMonitor

import Ouroboros.Network.Context
import Ouroboros.Network.Diffusion.Types (NodeToClientApplication)
