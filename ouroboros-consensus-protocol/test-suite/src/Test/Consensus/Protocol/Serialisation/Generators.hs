...
import Ouroboros.Consensus.Protocol.Praos.VRF (UnifiedVRF, mkUnifiedVRF)
import Test.Cardano.Ledger.Shelley.Serialisation.EraIndepGenerators ()
import Test.Crypto.KES ()
import Test.Crypto.VRF ()
import Test.QuickCheck (Arbitrary (..), Gen, choose, oneof)

instance Arbitrary UnifiedVRF where
  arbitrary = mkUnifiedVRF <$> arbitrary <*> arbitrary
