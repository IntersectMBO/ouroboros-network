...
pattern QueryIfCurrentShelley
  :: ()
  => CardanoQueryResult c result ~ a
  => BlockQuery (ShelleyBlock (ShelleyEra c)) fp result
  -> CardanoQuery c fp a
...
pattern QueryIfCurrentAllegra
  :: ()
  => CardanoQueryResult c result ~ a
  => BlockQuery (ShelleyBlock (AllegraEra c)) fp result
  -> CardanoQuery c fp a
...
pattern QueryIfCurrentMary
  :: ()
  => CardanoQueryResult c result ~ a
  => BlockQuery (ShelleyBlock (MaryEra c)) fp result
  -> CardanoQuery c fp a
...
pattern QueryIfCurrentAlonzo
  :: ()
  => CardanoQueryResult c result ~ a
  => BlockQuery (ShelleyBlock (AlonzoEra c)) fp result
  -> CardanoQuery c fp a
...
pattern LedgerStateShelley
  :: LedgerState (ShelleyBlock (ShelleyEra c)) mk
  -> CardanoLedgerState c mk
...
pattern LedgerStateAllegra
  :: LedgerState (ShelleyBlock (AllegraEra c)) mk
  -> CardanoLedgerState c mk
...
pattern LedgerStateMary
  :: LedgerState (ShelleyBlock (MaryEra c)) mk
  -> CardanoLedgerState c mk
...
pattern LedgerStateAlonzo
  :: LedgerState (ShelleyBlock (AlonzoEra c)) mk
  -> CardanoLedgerState c mk
