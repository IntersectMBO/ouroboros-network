...
module Cardano.KESAgent.Protocols.Control.V3.Protocol
where
...
data AgentInfo
  ...
  , agentInfoCurrentKESPeriodStart :: !UTCTime
  , agentInfoCurrentKESPeriodEnd :: !UTCTime
...
cpVersionIdentifier = mkVersionIdentifier "Control:3.0"
