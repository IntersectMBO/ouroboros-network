...
--
module Ouroboros.Chain.MockChain (
...
import qualified Ouroboros.Chain.ChainFragment as CF
...
addBlock :: block -> Chain block -> Chain block
addBlock b c = c :> b
...
fromChainFragment :: CF.ChainFragment block -> Chain block
