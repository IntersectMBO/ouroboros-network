...
https://github.com/IntersectMBO/cardano-node/blob/eeb0a0d8c99600e5add006d291467156b197b943/cardano-node/src/Cardano/Node/Tracing/Tracers/P2P.hs

--}

module DMQ.Tracer.Types.P2P
  () where
