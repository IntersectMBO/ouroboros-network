...
\todo{ND: Need Biz Level decision - is this still the avowed intended audience?}
...
As discussed in \cref{decentralisation-design}, prior graph theory \cite{Watts99} tells us that we can construct
...
\todo[inline]{previously we had colour in the tables, and the text
