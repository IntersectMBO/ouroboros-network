...
\subsection{​Fundamental requirements of Cardano data
diffusion}
...
\section{Outstanding/unresolved issues}
\label{outstandingunresolved-issues}
...
requirements]{\texorpdfstring{​12.1​~Business requirements\footnote{Reproduced
  ...
  self-contained document.}}{​12.1​~Business requirements}}
