...
\item The system will allow users syncing with the latest version of the
      blockchain to download blocks from more than one and up to five network
      peers concurrently.
...
of the network protocol and tries to give a big picture of the overall network protocol.
...
The design must operate appropriately in this situation and recover from transient conditions.
...
as adversarial behaviour of another node.
