...
\def\SelfConnA{\textsf{SelfConn}}
\def\SelfConnB{\textsf{SelfConn}\textsuperscript{\textsf{-1}}}
...
\begin{figure}[p]
  {\begin{tikzpicture}[scale=0.66]
    ...
    \draw[->] (UnnegotiatedStateOut)           -- node[fill=white, above=18pt, left] {\small \SelfConnA}               (UnnegotiatedStateIn);
    \draw[->] (UnnegotiatedStateIn)            -- node[fill=white, above=18pt, right] {\small \SelfConnB}              (UnnegotiatedStateOut);
    ...
    \draw[->]  (InboundIdleStateUni)           -- node[fill=white, left=6pt] {\small \SelfConnB}                       (OutboundStateUni);
