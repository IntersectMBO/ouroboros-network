...
The code currently uses the names \ensuremath{\Varid{requestOutboundConnection}} and
\ensuremath{\Varid{unregisterOutboundConnection}}. The names `request' and 'unregister' are not a
...
and hence API names \ensuremath{\Varid{acquireOutboundConnection}} and \ensuremath{\Varid{releaseOutboundConnection}}.
...
\>[B]{}\mathbf{data}\;\Conid{Connected}\;\Varid{peerAddr}\;\Varid{handle}\;\Varid{handleError}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  | We are connected and mux is running.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathrel{=}\Conid{Connected}{}\<[18]%
\>[18]{}\mathbin{!}(\Conid{ConnectionId}\;\Varid{peerAddr})\mathbin{!}\Varid{handle}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  | There was an error during handshake negotiation.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{Disconnected}\mathbin{!}(\Conid{ConnectionId}\;\Varid{peerAddr})\mathbin{!}(\Conid{Maybe}\;\Varid{handleError}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  | Include outbound connection into 'ConnectionManager'.}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment    This executes:}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(Reserve\) to \(Negotiated^{*}_{Outbound}\) transitions}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(PromotedToWarm^{Duplex}_{Local}\) transition}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(Awake^{Duplex}_{Local}\) transition}{}\<[E]%
\\
\>[B]{}\Varid{requestOutboundConnection}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbin{::}{}\<[7]%
\>[7]{}\Conid{HasInitiator}\;\Varid{muxMode}\mathord{\sim}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Rightarrow {}\<[7]%
\>[7]{}\Conid{ConnectionManager}\;\Varid{muxMode}\;\Varid{socket}\;\Varid{peerAddr}\;\Varid{handle}\;\Varid{handleError}\;\Varid{m}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\to {}\<[7]%
\>[7]{}\Varid{peerAddr}{}\<[E]%
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\to {}\<[7]%
\>[7]{}\Varid{m}\;(\Conid{Connected}\;\Varid{peerAddr}\;\Varid{handle}\;\Varid{handleError}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Include an inbound connection into 'ConnectionManager'.}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment    This executes:}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(Accepted\) \/ \(Overwritten\) to \(Negotiated^{*}_{Inbound}\) transitions}{}\<[E]%
\\
\>[B]{}\Varid{includeInboundConnection}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbin{::}{}\<[7]%
\>[7]{}\Conid{HasResponder}\;\Varid{muxMode}\mathord{\sim}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Rightarrow {}\<[7]%
\>[7]{}\Conid{ConnectionManager}\;\Varid{muxMode}\;\Varid{socket}\;\Varid{peerAddr}\;\Varid{handle}\;\Varid{handleError}\;\Varid{m}{}\<[E]%
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  | Custom either type for result of various methods.}{}\<[E]%
\\
\>[B]{}\mathbf{data}\;\Conid{OperationResult}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathrel{=}\Conid{UnsupportedState}\mathbin{!}\Conid{InState}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Conid{OperationSuccess}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  | Enumeration of states, used for reporting; constructors elided from this}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  specification.}{}\<[E]%
\\
\>[B]{}\mathbf{data}\;\Conid{InState}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  | Unregister an outbound connection.}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    This executes:}{}\<[E]%
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(DemotedToCold^{*}_{Local}\) transitions}{}\<[E]%
\\
\>[B]{}\Varid{unregisterOutboundConnection}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbin{::}{}\<[3E]%
\>[7]{}\Conid{HasInitiator}\;\Varid{muxMode}\mathord{\sim}\Conid{True}{}\<[E]%
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\to {}\<[3E]%
\>[7]{}\Varid{m}\;(\Conid{OperationResult}\;()){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  | Notify the 'ConnectionManager' that a remote end promoted us to a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  /warm peer/.}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  This executes:}{}\<[E]%
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(PromotedToWarm^{Duplex}_{Remote}\) transition,}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(Awake^{*}_{Remote}\) transition.}{}\<[E]%
\\
\>[B]{}\Varid{promotedToWarmRemote}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbin{::}{}\<[3E]%
\>[7]{}\Conid{HasInitiator}\;\Varid{muxMode}\mathord{\sim}\Conid{True}{}\<[E]%
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\to {}\<[3E]%
\>[7]{}\Varid{m}\;(\Conid{OperationResult}\;\Conid{InState}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  | Notify the 'ConnectionManager' that a remote end demoted us to a /cold}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  peer/.}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  This executes:}{}\<[E]%
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(DemotedToCold^{*}_{Remote}\) transition.}{}\<[E]%
\\
\>[B]{}\Varid{demotedToColdRemote}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbin{::}{}\<[3E]%
\>[7]{}\Conid{HasResponder}\;\Varid{muxMode}\mathord{\sim}\Conid{True}{}\<[E]%
...
\>[7]{}\Varid{m}\;(\Conid{OperationResult}\;\Conid{InState}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  | Unregister outbound connection. Returns if the operation was successul.}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  This executes:}{}\<[E]%
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(Commit*{*}\) transition}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  * \(TimeoutExpired\) transition}{}\<[E]%
\\
\>[B]{}\Varid{unregisterInboundConnection}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbin{::}{}\<[3E]%
\>[7]{}\Conid{HasResponder}\;\Varid{muxMode}\mathord{\sim}\Conid{True}{}\<[E]%
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\to {}\<[3E]%
\>[7]{}\Varid{m}\;(\Conid{OperationResult}\;\Conid{DemotedToColdRemoteTr}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  | Number of connections tracked by the server.}{}\<[E]%
\\
\>[B]{}\Varid{numberOfConnections}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbin{::}{}\<[3E]%
\>[7]{}\Conid{HasResponder}\;\Varid{muxMode}\mathord{\sim}\Conid{True}{}\<[E]%
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\to {}\<[3E]%
\>[7]{}\Conid{STM}\;\Varid{m}\;\Conid{Int}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;\Conid{Provenance}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathrel{=}\Conid{Inbound}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{Outbound}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;\Conid{DataFlow}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathrel{=}\Conid{Unidirectional}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{Duplex}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;\Conid{ConnectionState}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Connection manger is about to connect to a peer.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathrel{=}\Conid{ReservedOutboundState}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Connected to a peer, handshake negotiation is ongoing.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{UnnegotiatedState}\;\Conid{Provenance}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Outbound connection, inbound idle timeout is ticking.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{OutboundState} ^\tau\;\Conid{DataFlow}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Outbound connection, inbound idle timeout expired.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{OutboundState}\;\Conid{DataFlow}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Inbound connection, but not yet used.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{InboundIdleState} ^\tau\;\Conid{DataFlow}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Active inbound connection.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{InboundState}\;\Conid{DataFlow}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Connection runs in duplex mode: either outbound connection negotiated}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  'Duplex' data flow, or 'InboundState Duplex' was reused.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{DuplexState}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Connection manager is about to close (reset) the connection, before it}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  will do that it will put the connection in 'OutboundIdleState' and start}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  a timeout.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{OutboundIdleState}\mathbin{*}\text{\ttfamily '\$\char94 \char92 tau\$'}\mathbin{*}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Connection has terminated; socket is closed, thread running the}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  connection is killed.  For some delay (`TIME\_WAIT`) the connection is kept}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  in this state until the kernel releases all the resources.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{TerminatingState}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  Connection is forgotten.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{TerminatedState}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
This transitions is driven by the p2p governor when it decides to demote the peer
to the cold state, its domain is \OutboundStateAny{} or \OutboundStateDupTau{}.
...
\begin{detail}
  ...
  \texttt{unregisterOutboundConnection} (both are non-blocking), but the
  stateful idleness detection during \textit{protocol idle timeout} is
  implemented by the inbound governor.  The implementation is relying on two
  properties:
  \begin{itemize}
    \item the multiplexer being able to start mini-protocols on-demand, which
      allows us to restart a mini-protocol as soon as it returns, without
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{unregisterOutboundConnection}\mathbin{::}\Varid{peerAddr}\to \Varid{m}\;(){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{table}
  \begin{tabular}[h]{llll}
    ...
    \InboundIdleStateAny{}   & \TerminatingState{} & & \ensuremath{\Conid{True}} \\[8pt]
    \InboundStateAny{}       & \TerminatingState{}\textsuperscript{$\dagger$} &
      \begin{minipage}[t]{5cm}
        ...
        \end{itemize}
      \end{minipage}
        & \ensuremath{\Conid{True}} \\[8pt]
    \DuplexState{}           & \OutboundStateDup{} & \DemotedToColdDupRem{}  & \ensuremath{\Conid{False}} \\[8pt]
    \TerminatingState{}      & - & & - \\[8pt]
    \TerminatedState{}       & - & & - \\[8pt]
  \end{tabular}
...
the \AwakeDupRem{} transition is triggered and the inbound governor calls
...
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbin{::}{}\<[5E]%
\>[9]{}\Conid{HasResponder}\;\Varid{muxMode}\mathord{\sim}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Rightarrow {}\<[5E]%
\>[9]{}\Conid{ConnectionManager}\;\Varid{muxMode}\;\Varid{socket}\;\Varid{peerAddr}\;\Varid{handle}\;\Varid{handleError}\;\Varid{m}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\to {}\<[5E]%
\>[9]{}\Varid{peerAddr}{}\<[E]%
...
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\to {}\<[5E]%
\>[9]{}\Varid{m}\;(\Conid{OperationResult}\;\Conid{InState}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

When all responder mini-protocols are idle for \textit{protocol idle timeout},
the inbound governor will execute \texttt{unregisterInboundConnection} which will trigger:
\begin{itemize}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  | Return value of 'unregisterInboundConnection' to inform the caller about}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  the transition.}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mathbf{data}\;\Conid{DemotedToColdRemoteTr}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  | \text{\ttfamily Commit\char94{}\char123{}dataFlow\char125{}} transition from \text{\ttfamily \char39{}InboundIdleState\char39{}~dataFlow}.}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{CommitTr}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  | \text{\ttfamily DemotedToCold\char94{}\char123{}Remote\char125{}} transition from \text{\ttfamily \char39{}InboundState\char39{}~dataFlow}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{DemotedToColdRemoteTr}{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  | Either \text{\ttfamily DemotedToCold\char94{}\char123{}Remote\char125{}} transition from \text{\ttfamily \char39{}DuplexState\char39{}}, or}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  a level triggered \text{\ttfamily Awake\char94{}\char123{}Duplex\char125{}\char95{}\char123{}Local\char125{}} transition.  In both cases}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  the server must keep the responder side of all protocols ready.}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Conid{KeepTr}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{deriving}\;\Conid{Show}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{unregisterInboundConnection}\mathbin{::}\Varid{peerAddr}\to \Varid{m}\;(\Conid{OperationResult}\;\Conid{DemotedToColdRemoteTr}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
