...
\hsref{typed-protocols-examples/src/Network/TypedProtocol/PingPong/Type.hs}
...
\subsubsection{State machine}
\hsref{typed-protocols-examples/src/Network/TypedProtocol/ReqResp/Type.hs}
...
\hsref{ouroboros-network-framework/src/Ouroboros/Network/Protocol/Handshake/Type.hs}
...
\hsref{ouroboros-network/src/Ouroboros/Network/Protocol/TxSubmission2/Type.hs}
...
\hsref{ouroboros-network/src/Ouroboros/Network/Protocol/KeepAlive/Type.hs}
...
\newcommand{\Client}{\state{Client}}
\newcommand{\Server}{\state{Server}}
...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=4.5cm, semithick]
  ...
  \node[state, below of=Client]       (Done)    {\Done};
...
\hsref{ouroboros-network/src/Ouroboros/Network/Protocol/LocalTxSubmission/Type.hs}
...
\hsref{ouroboros-network/src/Ouroboros/Network/Protocol/LocalStateQuery/Type.hs}
...
\begin{tikzpicture}[->,=>stealth',shorten >=1pt,auto,node distance=4cm,semithick]
  \tikzstyle{every state}=[fill=red,draw,none,text=white]
  \node[state, green, initial] (Idle) {\Idle};
  \node[state, blue, right of=Idle] (Acquiring) {\Acquiring};
  \node[state, green, right of=Acquiring] (Acquired) {\Acquired};
  \node[state, blue, right of=Acquired] (Querying) {\Querying};
...
\hsref{ouroboros-network/src/Ouroboros/Network/NodeToNode/Version.hs}\newline
...
\hsref{ouroboros-network/src/Ouroboros/Network/NodeToClient/Version.hs}\newline
