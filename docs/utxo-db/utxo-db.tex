...
Rather than an LSM tree, one might use a B+-tree \cite{journals/csur/Comer79}, the basis
...
\footnote{https://rocksdb.org/}, levelDB
\footnote{https://github.com/google/leveldb}, sqlite3
\footnote{https://www.sqlite.org/index.html}, postresql
\footnote{https://www.postgresql.org/}. We
...
\todo[inline]{Should we cite IOHK RocksDB history?}
...
\todo[inline]{Address ability to meet changing requirements going forward? Likely more constrained by Off-the-Shelf}
...
As discussed in \ref{assessing-feasibility} there is reason to expect that any solution
