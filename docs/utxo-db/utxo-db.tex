...
\end{enumerate}
\todo{DUNCAN: should this be included above ?}
...
\todo{cite}, levelDB \todo{cit}, sqlite3 \todo{cite}, postresql \todo{cite}. We
...
As described in \ref{parallel}, we will have the choice to use Parallel IO,
