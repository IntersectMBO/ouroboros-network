...
instance (Era c, PraosCrypto c) => ProtocolHeaderSupportsEnvelope (Praos c) where
...
instance (Era c, PraosCrypto c) => ProtocolHeaderSupportsKES (Praos c) where
...
instance (Era c, PraosCrypto c) => ProtocolHeaderSupportsProtocol (Praos c) where
...
instance (Era c, PraosCrypto c) => ProtocolHeaderSupportsLedger (Praos c) where
...
instance (Era c, PraosCrypto c) => ShelleyProtocol (Praos c)
